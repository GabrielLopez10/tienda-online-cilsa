export function footer() {
  ...
  if (footerContainer) {
    ...
    const rightColumnContent = isContactPage
      ? `<div class="col-md-4 offset-md-1 mt-5">
                <h1 id="footer-brand">AutoTech Fusión</h1>
            </div>`
      : `<div class="col-md-4 offset-md-1 mt-5">
                <form id="newsletterForm" class="needs-validation" novalidate>
                    <h5>Suscríbase a nuestro boletin</h5>
                    ...
                    <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                        ...
                        <input type="email" class="form-control" id="newsletterEmail" placeholder="Correo Electrónico" required>
    ...
    footerContainer.innerHTML = `
           <footer class="container">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-5 mt-5 mx-2 mx-md-0 ">
                    <h5>Secciones</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="index.html" class="nav-link p-0 text-body-secondary">Home</a></li>
                        <li class="nav-item mb-2"><a href="productos.html" class="nav-link p-0 text-body-secondary">Categorias</a></li>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                <p>&copy; 2024 AutoTech Fusión, Inc.</p>
                <ul class="list-unstyled d-flex">
                    <li class="ms-0"><a class="link-body-emphasis" href="#"><svg class="bi" width="24" height="24"><use href="#twitter" /></svg></a></li>
